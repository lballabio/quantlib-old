...
(define SimpleSwap-suite
  (make-test-suite 
   "Simple-swap tests"
   (make-test-case/msg "Testing simple swap calculation of fair fixed rate"
                       (SimpleSwap-fair-rate-test))
   (make-test-case/msg 
    "Testing simple swap calculation of fair floating spread"
    (SimpleSwap-fair-spread-test))
   (make-test-case/msg "Testing simple swap dependency on fixed rate"
                       (SimpleSwap-rate-dependency-test))
   (make-test-case/msg "Testing simple swap dependency on floating spread"
                       (SimpleSwap-spread-dependency-test))
   (make-test-case/msg "Testing simple swap calculation against cached value"
                       (SimpleSwap-cached-value-test))))
