...
(define Swaption-suite
  (make-test-suite 
   "Swaption tests"
   (make-test-case/msg "Testing swaption dependency on strike"
                       (Swaption-strike-dependency-test))
   (make-test-case/msg "Testing swaption dependency on spread"
                       (Swaption-spread-dependency-test))
   (make-test-case/msg "Testing swaption treatment of spread"
                       (Swaption-spread-treatment-test))
   (make-test-case/msg "Testing swaption value against cached value"
                       (Swaption-cached-value-test))))
