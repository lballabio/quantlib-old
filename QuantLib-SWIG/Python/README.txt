...
available from <http://www.swig.org/>; SWIG version 1.3.29 is
needed. Features used in the QuantLib-Python interface files require
Python version 2.2 or later. Also note that code generated by SWIG 1.3.29
cannot be compiled with Visual C++ 6.
