...
int main()
{
    ...
    LARGE_TITLE("Test: Margrabe Option");
    ...
    LARGE_TITLE("Test: Rainbow Option");
    /*
    References:
        Peter Ouwehand and Graeme West. Pricing rainbow options, Wilmott Magazine, p 74-80, May 2006. pdf
        http://math.sun.ac.za/~peter_ouwehand/Pricing_Rainbows__Ouwehand_West.pdf
        http://www.iassa.co.za/wp-content/uploads/2009/06/0607Ouwehand64No5final.pdf
