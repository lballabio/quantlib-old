// Adapted from test-suite/jumpdiffusion.cpp

#include "jumpdiffusiontest.hpp"
...
void testJumpDiffusion() {
    LARGE_TITLE("Test: Jump Diffusion");
    HaugMertonData values[] = {
        //        type, strike,   spot,    q,    r,    t,  vol, int, gamma, value, tol
        // gamma = 0.25, strike = 80
        { Option::Call,  80.00, 100.00, 0.00, 0.08, 0.10, 0.25, 1.0,  0.25, 20.67, 1e-2 },
    ...
    for (Size i=0; i<2 /*LENGTH(values)*/; i++) {
