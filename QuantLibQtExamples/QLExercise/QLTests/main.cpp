    ...
    try {
        ...
        */
        ...
        /* pricing model components
           1. Process        HestonProcess
           2. Model          HestonModel(HestonProcess)
           3. PricingEngine  AnalyticHestonEngine(HestonModel)
           4. VanillaOption.setPricingEngine(AnalyticHestonEngine)

        */

        //------------------------------------------------------------------------------
        {
            //LARGE_TITLE("Jump Diffusion");
