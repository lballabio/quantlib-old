...
void VarianceSwapTest::testReplicatingVarianceSwap() {
    ...
    ReplicatingVarianceSwapData values[] = {
		...
		{Position::Long, 0.02, 50000, 100.0, 0.00, 0.05, 0.246575, 0.20, 0.04189, 1.0e-4},
		{Position::Long, 0.06, 50000, 100.0, 0.00, 0.05, 0.246575, 0.20, 0.04189, 1.0e-4},
		{Position::Long, 0.04, 50000, 100.0, 0.00, 0.05, 0.246575, 0.40, 0.04189, 1.0e-4},
		{Position::Long, 0.04, 50000, 100.0, 0.00, 0.05, 0.246575, 0.60, 0.04189, 1.0e-4},
		{Position::Long, 0.04, 50000, 100.0, 0.00, 0.05, 0.246575, 0.80, 0.04189, 1.0e-4},
		{Position::Short, 0.04, 50000, 100.0, 0.00, 0.05, 0.246575, 0.70, 0.04189, 1.0e-4},
		{Position::Short, 0.04, 50000, 100.0, 0.00, 0.05, 0.246575, 1.40, 0.04189, 1.0e-4}
	...
	std::cout << "Fair Strike of Variance Swap" << std::endl;
    for (Size i=0; i<LENGTH(values); i++) {
        ...
        Size options = LENGTH(replicatingOptionData); //17
        ...
        Matrix vols(options-1, 1); //16
        std::vector<Real> strikes;
        for (j=0; j<putVols.size(); j++) { //11
            vols[j][0] = putVols[j];
            strikes.push_back(putStrikes[j]);
        }

        for (Size k=1; k<callVols.size(); k++) { //8
		...
		*/
		...
		if(i==0){
			std::cout << "start date: " << varianceSwap.startDate() << std::endl;
			std::cout << "maturity date: " << varianceSwap.maturityDate() << std::endl;
			std::cout << "notional: " << varianceSwap.notional() << std::endl;
			std::cout << "Fair Strike: " << calculated << "\tExpected: " << expected << "\tError: " << error << std::endl;
		}		
		std::cout << "strike: " << varianceSwap.strike() << std::endl;
		std::cout << "position: " << varianceSwap.position() << std::endl;
		std::cout << "Variance Swap NPV: " << varianceSwap.NPV() << std::endl << std::endl;
    ...
    for (Size i=0; i<LENGTH(values); i++) {
        ...
        if (error>values[i].tol)
            REPORT_FAILURE("value", values[i].type, values[i].varStrike,
                           ...
                           values[i].r, today, exDate, values[i].v, expected,
                           calculated, error, values[i].tol);
		std::cout << "Variance: " << calculated << "\tExpected: " << expected << "\tError: " << error << std::endl;
    }
}
//
