                          ...
                          Size timeSteps)
{
    ...
    //boost::shared_ptr<PricingEngine> euro_pe(new FDEuropeanEngine<CrankNicolson>(bsmProcess, timeSteps, timeSteps-1));
	...
	euro.setPricingEngine(boost::shared_ptr<PricingEngine>(
		new FDEuropeanEngine<CrankNicolson>(bsmProcess,
		timeSteps,timeSteps-1)));
	berm.setPricingEngine(boost::shared_ptr<PricingEngine>(
		new FDBermudanEngine<CrankNicolson>(bsmProcess,
		timeSteps,timeSteps-1)));
	amer.setPricingEngine(boost::shared_ptr<PricingEngine>(
...
int main(int, char* []) {
    ...
    try {
		...
		BOOST_MESSAGE("Testing finite difference methods...");
