...
int main()
{
    ...
    QuantoOptionTest::testValues();
    QuantoOptionTest::testGreeks();
    QuantoOptionTest::testForwardValues();
    QuantoOptionTest::testForwardGreeks();
    QuantoOptionTest::testForwardPerformanceValues();
    QuantoOptionTest::testBarrierValues();
