...
#ifndef quantlib_test_custom_utilities_tweak_hpp
#define quantlib_test_custom_utilities_tweak_hpp
...
#define BOOST_TEST_MESSAGE(title) \
    std::cout << std::endl << std::endl;\
    std::cout << "=======================================================================" << std::endl;\
    std::cout << title << std::endl;\
    std::cout << "=======================================================================" << std::endl;
...
#endif //quantlib_test_custom_utilities_tweak_hpp
