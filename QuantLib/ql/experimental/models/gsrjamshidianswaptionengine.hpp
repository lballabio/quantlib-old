...
/*! \file gsrjamshidianswaptionengine.hpp
    \brief Swaption engine using Jamshidian's decomposition
*/

#ifndef quantlib_pricers_gsr_jamshidian_swaption_hpp
...
namespace QuantLib {
    ...
    */
    class GsrJamshidianSwaptionEngine
      ...
      public:
        ...
        */
        GsrJamshidianSwaptionEngine(const boost::shared_ptr<Gsr>& model)
