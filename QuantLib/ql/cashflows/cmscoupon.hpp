...
namespace QuantLib {
    ...
    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withNotionals(T notional) {
    ...
    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withPaymentAdjustment(BusinessDayConvention convention) {
    ...
    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withFixingDays(const std::vector<Natural>& fixingDays) {
        fixingDays_ = fixingDays;
        return *this;
    }

    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withGearings(T gearing) {
    ...
    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withSpreads(T spread) {
    ...
    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withCaps(T cap) {
    ...
    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withFloors(T floor) {
    ...
    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::inArrears(bool flag) {
        inArrears_ = flag;
        return *this;
    }

    template<class T>
    CmsLeg_t<T>& CmsLeg_t<T>::withZeroPayments(bool flag) {
        zeroPayments_ = flag;
        return *this;
    }

    template<class T>
    CmsLeg_t<T>::operator Leg() const {
