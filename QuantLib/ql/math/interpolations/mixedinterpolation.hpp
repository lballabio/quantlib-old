...
template <class I1, class I2, template <class> class Interpolator1,
          template <class> class Interpolator2>
class MixedInterpolationImpl : public Interpolation::templateImpl<I1, I2> {
  public:
    MixedInterpolationImpl(
        const I1 &xBegin, const I1 &xEnd, const I2 &yBegin, Size n,
        const Interpolator1<Real> &factory1 = Interpolator1<Real>(),
        const Interpolator2<Real> &factory2 = Interpolator2<Real>())
        : Interpolation::templateImpl<I1, I2>(xBegin, xEnd, yBegin), n_(n) {

        xBegin2_ = this->xBegin_ + n;

        QL_REQUIRE(xBegin2_ < this->xEnd_, "too large n ("
                                               << n << ") for "
  ...
  public:
    ...
    MixedLinearCubicInterpolation(const I1 &xBegin, const I1 &xEnd,
        ...
        impl_ = boost::shared_ptr<Interpolation::Impl>(
            new detail::MixedInterpolationImpl<I1, I2, Linear, Cubic>(
                xBegin, xEnd, yBegin, n, Linear<Real>(),
...
template <class T = Real> class MixedLinearCubic {
  public:
    MixedLinearCubic(Size n, CubicInterpolation::DerivativeApprox da,
                     bool monotonic = true,
        ...
        : n_(n), da_(da), monotonic_(monotonic), leftType_(leftCondition),
          rightType_(rightCondition), leftValue_(leftConditionValue),
          rightValue_(rightConditionValue) {}
    template <class I1, class I2>
    Interpolation interpolate(const I1 &xBegin, const I1 &xEnd,
                              const I2 &yBegin) const {
        return MixedLinearCubicInterpolation(xBegin, xEnd, yBegin, n_, da_,
  ...
  public:
    ...
    MixedLinearCubicNaturalSpline(const I1 &xBegin, const I1 &xEnd,
        ...
        : MixedLinearCubicInterpolation(
              xBegin, xEnd, yBegin, n, CubicInterpolation::Spline, false,
...
class MixedLinearMonotonicCubicNaturalSpline
  ...
  public:
    ...
    MixedLinearMonotonicCubicNaturalSpline(const I1 &xBegin, const I1 &xEnd,
                                           const I2 &yBegin, Size n)
        : MixedLinearCubicInterpolation(
              xBegin, xEnd, yBegin, n, CubicInterpolation::Spline, true,
              CubicInterpolation::SecondDerivative, 0.0,
              CubicInterpolation::SecondDerivative, 0.0) {}
};
...
class MixedLinearKrugerCubic : public MixedLinearCubicInterpolation {
  public:
    /*! \pre the \f$ x \f$ values must be sorted. */
    template <class I1, class I2>
    MixedLinearKrugerCubic(const I1 &xBegin, const I1 &xEnd, const I2 &yBegin,
                           Size n)
        : MixedLinearCubicInterpolation(
              xBegin, xEnd, yBegin, n, CubicInterpolation::Kruger, false,
              CubicInterpolation::SecondDerivative, 0.0,
              CubicInterpolation::SecondDerivative, 0.0) {}
};
...
class MixedLinearFritschButlandCubic : public MixedLinearCubicInterpolation {
  public:
    ...
    MixedLinearFritschButlandCubic(const I1 &xBegin, const I1 &xEnd,
                                   const I2 &yBegin, Size n)
        : MixedLinearCubicInterpolation(
              xBegin, xEnd, yBegin, n, CubicInterpolation::FritschButland,
...
class MixedLinearParabolic : public MixedLinearCubicInterpolation {
  public:
    /*! \pre the \f$ x \f$ values must be sorted. */
    template <class I1, class I2>
    MixedLinearParabolic(const I1 &xBegin, const I1 &xEnd, const I2 &yBegin,
                         Size n)
        : MixedLinearCubicInterpolation(
              xBegin, xEnd, yBegin, n, CubicInterpolation::Parabolic, false,
              CubicInterpolation::SecondDerivative, 0.0,
              CubicInterpolation::SecondDerivative, 0.0) {}
};
...
class MixedLinearMonotonicParabolic : public MixedLinearCubicInterpolation {
  public:
    ...
    MixedLinearMonotonicParabolic(const I1 &xBegin, const I1 &xEnd,
                                  const I2 &yBegin, Size n)
        : MixedLinearCubicInterpolation(
              xBegin, xEnd, yBegin, n, CubicInterpolation::Parabolic, true,
              CubicInterpolation::SecondDerivative, 0.0,
              CubicInterpolation::SecondDerivative, 0.0) {}
};
}
