        ...
        for (Size i = 0; i < 4; i++) {
            instruments.push_back(boost::shared_ptr<DefaultProbabilityHelper>(
                new SpreadCdsHelper(Handle<Quote>(boost::shared_ptr<Quote>(
                                    ...
                                    tenors[i], 0, calendar, Quarterly,
                                    Following, DateGeneration::TwentiethIMM,
                                    Actual365Fixed(), recovery_rate, tsCurve)));
        }
...
int main(int, char * []) {
    ...
    cout << "=========================================" << endl;
    cout << "Example 2 - Pricing against Murex" << endl;
    cout << "=========================================" << endl;
