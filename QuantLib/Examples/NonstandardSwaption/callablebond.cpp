...
int main(int, char* []) {
	...
	boost::shared_ptr<NonstandardSwap> underlying(new NonstandardSwap(NonstandardSwap::Receiver,fixedNominal,floatingNominal,
                                                                      fixedSchedule,fixedRate,Thirty360(),floatingSchedule,
                                                                      iborIndex,0.0,Actual360(),true));
    ...
    boost::shared_ptr<PricingEngine> nonStandardEngine(new GsrNonstandardSwaptionEngine(gsr,64,7.0,true,false,
                                                                                        zSpreadQuote));
