...
#include <ql/experimental/models/gsr/gsrjamshidianswaptionengine.hpp>
#include <ql/math/solvers1d/brent.hpp>

namespace QuantLib {

    class GsrJamshidianSwaptionEngine::rStarFinder {
      public:
        rStarFinder(const boost::shared_ptr<Gsr>& model,
                    Real nominal,
    ...
    void GsrJamshidianSwaptionEngine::calculate() const {
