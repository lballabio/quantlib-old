...
namespace QuantLib {
    ...
    FdmDupire1dOp::FdmDupire1dOp(const boost::shared_ptr<FdmMesher>& mesher, const Array& localVolatility) : 
    ...
    Disposable<Array>
        FdmDupire1dOp::solve_splitting(Size direction,
    ...
    Disposable<Array>
        FdmDupire1dOp::preconditioner(const Array& r, Real dt) const {
    ...
    FdmDupire1dOp::toMatrixDecomp() const {
