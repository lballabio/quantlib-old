...
!MESSAGE 
!MESSAGE NMAKE /f "ohxll.mak" CFG="ohxll - Win32 Release MTDLL"
!MESSAGE 
...
!IF  "$(CFG)" == "ohxll - Win32 Release MTDLL"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib log4cxxs.lib Ws2_32.lib /nologo /dll /machine:I386 /out:"xll\ObjectHandler-vc6-mt-0_1_3.xll" /libpath:"..\xlsdk\lib" /libpath:"$(LOG4CXX_DIR)\msvc\Lib\Release"

!ELSEIF  "$(CFG)" == "ohxll - Win32 Debug MTDLL"
