...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib Ws2_32.lib /nologo /dll /machine:I386 /out:"xll\ObjectHandler-vc6-mt-0_1_4.xll" /libpath:"..\xlsdk\lib" /libpath:"$(LOG4CXX_DIR)\msvc\Lib"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib Ws2_32.lib /nologo /dll /debug /machine:I386 /out:"xll\ObjectHandler-vc6-mt-gd-0_1_4.xll" /pdbtype:sept /libpath:"..\xlsdk\lib" /libpath:"$(LOG4CXX_DIR)\msvc\Lib"
