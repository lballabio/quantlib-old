...
ROOT_DIRS = (
    ...
    '/home/erik/repos/quantlib/gensrc',
    '/home/erik/repos/quantlib/ObjectHandler',
    '/home/erik/repos/quantlib/QuantLibAddin',
    '/home/erik/repos/quantlib/QuantLibXL'
)
...
##  Frequently used
    (re.compile('1_2_0'), '1_3_0'),
    (re.compile('1\.2\.0'), '1.3.0'),
    (re.compile('0x010200'), '0x010300'),
    (re.compile('R010201f0'), 'R010300f0'),
