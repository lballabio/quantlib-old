...
CFG=AddinExcelStatic - Win32 Debug MTDLL
...
!MESSAGE 
!MESSAGE NMAKE /f "AddinExcelStatic.mak" CFG="AddinExcelStatic - Win32 Debug MTDLL"
!MESSAGE 
...
!IF  "$(CFG)" == "AddinExcelStatic - Win32 Debug MTDLL"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "..\.." /I "$(OBJECT_HANDLER_DIR)" /I "$(QL_DIR)" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "XLL_STATIC" /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib log4cxx.lib /nologo /dll /debug /machine:I386 /out:"xll\QuantLibAddinStatic-vc6-mt-gd-0_3_12.xll" /pdbtype:sept /libpath:"$(OBJECT_HANDLER_DIR)\xlsdk\lib" /libpath:"$(OBJECT_HANDLER_DIR)\ohxl\ohxllib\lib" /libpath:"$(QL_DIR)\lib" /libpath:"$(LOG4CXX_DIR)/msvc/lib/Debug"
...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "..\.." /I "$(OBJECT_HANDLER_DIR)" /I "$(QL_DIR)" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "XLL_STATIC" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib log4cxx.lib /nologo /dll /machine:I386 /out:"xll\QuantLibAddinStatic-vc6-mt-0_3_12.xll" /libpath:"$(OBJECT_HANDLER_DIR)\xlsdk\lib" /libpath:"$(OBJECT_HANDLER_DIR)\ohxl\ohxllib\lib" /libpath:"$(QL_DIR)\lib" /libpath:"$(LOG4CXX_DIR)/msvc/lib/Debug"
