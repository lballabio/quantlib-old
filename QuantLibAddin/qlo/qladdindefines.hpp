...
#if OBJHANDLER_HEX_VERSION < 0x000905f0
    #error using an old version of ObjectHandler, please update.
#endif

#include <ql/qldefines.hpp>
#if QL_HEX_VERSION < 0x000905f0
    #error using an old version of QuantLib, please update.
#endif

//! version string
#ifdef _DEBUG
    #define QLADDIN_VERSION "0.9.5-debug"
#else
    #define QLADDIN_VERSION "0.9.5"
#endif

//! version hexadecimal number
#define QLADDIN_HEX_VERSION 0x000905f0
