...
#if OBJHANDLER_HEX_VERSION < 0x010001f0
    #error using an old version of ObjectHandler, please update.
#endif

#include <ql/version.hpp>
#if QL_HEX_VERSION < 0x010001b2
    #error using an old version of QuantLib, please update.
#endif

//! version string
#ifdef _DEBUG
    #define QLADDIN_VERSION "1.0.1-debug"
#else
    #define QLADDIN_VERSION "1.0.1"
#endif

//! version hexadecimal number
#define QLADDIN_HEX_VERSION 0x010001f0
//! version string for output lib name
#define QLADDIN_LIB_VERSION "1_0_1"
