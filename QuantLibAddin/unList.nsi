; Eric - this file taken from http://forums.winamp.com/showthread.php?s=&threadid=213182
; (version 1.5 including subsequent patches listed at that link)
; Used for the uninstaller to prevent deletion of files that have been modified.
;
;-----------------------------------------------------------------------------------------------
...
Function FilesCallback
    ...
    # exclude seconds from the comparison otherwise inaccurate clock causes comparison to fail
