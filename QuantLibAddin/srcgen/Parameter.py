...
class Parameter(Serializable.Serializable):
    ...
    def serialize(self, serializer):
        ...
        serializer.serializeProperty(self.__dict__, TENSOR_RANK)
        serializer.serializeProperty(self.__dict__, common.DESCRIPTION)
        serializer.serializeAttributeBoolean(self.__dict__, IGNORE)
...
class ReturnValue(Serializable.Serializable):
    ...
    def __init__(self):
        """sometimes a ReturnValue will be treated like a Parameter in which case
        the properties below require default values"""
        self.name = ''
        self.default = False
